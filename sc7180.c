...
static struct measure_clk sc7180_clocks[] = {
	...
	/* DISP_CC */
	{ "disp_cc_mdss_ahb_clk", &gcc, 0x47, &disp_cc, 0x14 },
	{ "disp_cc_mdss_byte0_clk", &gcc, 0x47, &disp_cc, 0xc },
	{ "disp_cc_mdss_byte0_intf_clk", &gcc, 0x47, &disp_cc, 0xd },
	{ "disp_cc_mdss_dp_aux_clk", &gcc, 0x47, &disp_cc, 0x13 },
	{ "disp_cc_mdss_dp_crypto_clk", &gcc, 0x47, &disp_cc, 0x11 },
	{ "disp_cc_mdss_dp_link_clk", &gcc, 0x47, &disp_cc, 0xf },
	{ "disp_cc_mdss_dp_link_intf_clk", &gcc, 0x47, &disp_cc, 0x10 },
	{ "disp_cc_mdss_dp_pixel_clk", &gcc, 0x47, &disp_cc, 0x12 },
	{ "disp_cc_mdss_esc0_clk", &gcc, 0x47, &disp_cc, 0xe },
	{ "disp_cc_mdss_mdp_clk", &gcc, 0x47, &disp_cc, 0x8 },
	{ "disp_cc_mdss_mdp_lut_clk", &gcc, 0x47, &disp_cc, 0xa },
	{ "disp_cc_mdss_non_gdsc_ahb_clk", &gcc, 0x47, &disp_cc, 0x15 },
	{ "disp_cc_mdss_pclk0_clk", &gcc, 0x47, &disp_cc, 0x7 },
	{ "disp_cc_mdss_rot_clk", &gcc, 0x47, &disp_cc, 0x9 },
	{ "disp_cc_mdss_rscc_ahb_clk", &gcc, 0x47, &disp_cc, 0x17 },
	{ "disp_cc_mdss_rscc_vsync_clk", &gcc, 0x47, &disp_cc, 0x16 },
	{ "disp_cc_mdss_vsync_clk", &gcc, 0x47, &disp_cc, 0xb },
	{ "disp_cc_sleep_clk", &gcc, 0x47, &disp_cc, 0x1e },
	{ "disp_cc_xo_clk", &gcc, 0x47, &disp_cc, 0x1d },
	...
	{ "gcc_camera_throttle_hf_axi_clk", &gcc, 0x1aa },
	...
	{ "gcc_disp_throttle_hf_axi_clk", &gcc, 0x1ab },
	...
	{ "gcc_npu_bwmon_axi_clk", &gcc, 0x182 },
	{ "gcc_npu_bwmon_dma_cfg_ahb_clk", &gcc, 0x7e },
	{ "gcc_npu_bwmon_dsp_cfg_ahb_clk", &gcc, 0x7f },
	{ "gcc_npu_cfg_ahb_clk", &gcc, 0x169 },
	{ "gcc_npu_dma_clk", &gcc, 0x185 },
	...
	{ "gcc_qspi_cnoc_periph_ahb_clk", &gcc, 0x1b0 },
	{ "gcc_qspi_core_clk", &gcc, 0x1b1 },
	...
	{ "gcc_video_gpll0_div_clk_src", &gcc, 0x18a },
	{ "gcc_video_throttle_axi_clk", &gcc, 0x1a9 },
	{ "gcc_video_xo_clk", &gcc, 0x42 },

	/* GPU_CC */
	{ "gpu_cc_acd_ahb_clk", &gcc, 0x144, &gpu_cc, 0x24 },
	...
	{ "gpu_cc_cx_qdss_at_clk", &gcc, 0x144, &gpu_cc, 0x13 },
	{ "gpu_cc_cx_qdss_trig_clk", &gcc, 0x144, &gpu_cc, 0x18 },
	{ "gpu_cc_cx_qdss_tsctr_clk", &gcc, 0x144, &gpu_cc, 0x14 },
	...
	{ "gpu_cc_gx_qdss_tsctr_clk", &gcc, 0x144, &gpu_cc, 0xe },
	{ "gpu_cc_gx_vsense_clk", &gcc, 0x144, &gpu_cc, 0xd },
	{ "gpu_cc_rbcpr_ahb_clk", &gcc, 0x144, &gpu_cc, 0x1d },
	{ "gpu_cc_rbcpr_clk", &gcc, 0x144, &gpu_cc, 0x1c },
	{ "gpu_cc_sleep_clk", &gcc, 0x144, &gpu_cc, 0x17 },

	/* Bus clocks */
	{ "measure_only_mccc_clk", &gcc, 0xc2, &mc_cc, 0x50 },
	{ "measure_only_cnoc_clk", &gcc, 0x15 },
	{ "measure_only_ipa_2x_clk", &gcc, 0x128 },
	{ "measure_only_snoc_clk", &gcc, 0x7 },

	/* NPU_CC */
	{ "npu_cc_atb_clk", &gcc, 0x16f, &npu_cc, 0x17 },
	{ "npu_cc_bto_core_clk", &gcc, 0x16f, &npu_cc, 0x19 },
	{ "npu_cc_bwmon_clk", &gcc, 0x16f, &npu_cc, 0x18 },
	{ "npu_cc_cal_hm0_cdc_clk", &gcc, 0x16f, &npu_cc, 0xb },
	{ "npu_cc_cal_hm0_clk", &gcc, 0x16f, &npu_cc, 0x2 },
	{ "npu_cc_cal_hm0_perf_cnt_clk", &gcc, 0x16f, &npu_cc, 0xd },
	{ "npu_cc_core_clk", &gcc, 0x16f, &npu_cc, 0x4 },
	{ "npu_cc_dsp_ahbm_clk", &gcc, 0x16f, &npu_cc, 0x1c },
	{ "npu_cc_dsp_ahbs_clk", &gcc, 0x16f, &npu_cc, 0x1b },
	{ "npu_cc_dsp_axi_clk", &gcc, 0x16f, &npu_cc, 0x1e },
	{ "npu_cc_noc_ahb_clk", &gcc, 0x16f, &npu_cc, 0x13 },
	{ "npu_cc_noc_axi_clk", &gcc, 0x16f, &npu_cc, 0x12 },
	{ "npu_cc_noc_dma_clk", &gcc, 0x16f, &npu_cc, 0x11 },
	{ "npu_cc_rsc_xo_clk", &gcc, 0x16f, &npu_cc, 0x1a },
	{ "npu_cc_s2p_clk", &gcc, 0x16f, &npu_cc, 0x16 },
	{ "npu_cc_xo_clk", &gcc, 0x16f, &npu_cc, 0x1 },

	/* VIDEO_CC */
	{ "video_cc_apb_clk", &gcc, 0x48, &video_cc, 0xa },
	{ "video_cc_at_clk", &gcc, 0x48, &video_cc, 0xd },
	{ "video_cc_qdss_trig_clk", &gcc, 0x48, &video_cc, 0x9 },
	{ "video_cc_qdss_tsctr_div8_clk", &gcc, 0x48, &video_cc, 0xc },
	{ "video_cc_sleep_clk", &gcc, 0x48, &video_cc, 0x6 },
	{ "video_cc_vcodec0_axi_clk", &gcc, 0x48, &video_cc, 0x8 },
	{ "video_cc_vcodec0_core_clk", &gcc, 0x48, &video_cc, 0x3 },
	{ "video_cc_venus_ahb_clk", &gcc, 0x48, &video_cc, 0xb },
	{ "video_cc_venus_ctl_axi_clk", &gcc, 0x48, &video_cc, 0x7 },
	{ "video_cc_venus_ctl_core_clk", &gcc, 0x48, &video_cc, 0x1 },
	{ "video_cc_xo_clk", &gcc, 0x48, &video_cc, 0x5 },
	...
	{ "cam_cc_camnoc_atb_clk", &gcc, 0x46, &cam_cc, 0x34 },
	{ "cam_cc_camnoc_axi_clk", &gcc, 0x46, &cam_cc, 0x2d },
	{ "cam_cc_cci_0_clk", &gcc, 0x46, &cam_cc, 0x2a },
	{ "cam_cc_cci_1_clk", &gcc, 0x46, &cam_cc, 0x3b },
	{ "cam_cc_core_ahb_clk", &gcc, 0x46, &cam_cc, 0x3a },
	...
	{ "cam_cc_csi3phytimer_clk", &gcc, 0x46, &cam_cc, 0x13 },
	{ "cam_cc_csiphy0_clk", &gcc, 0x46, &cam_cc, 0x6 },
	{ "cam_cc_csiphy1_clk", &gcc, 0x46, &cam_cc, 0x8 },
	{ "cam_cc_csiphy2_clk", &gcc, 0x46, &cam_cc, 0xa },
	{ "cam_cc_csiphy3_clk", &gcc, 0x46, &cam_cc, 0x14 },
	{ "cam_cc_icp_apb_clk", &gcc, 0x46, &cam_cc, 0x32 },
	{ "cam_cc_icp_atb_clk", &gcc, 0x46, &cam_cc, 0x2f },
	{ "cam_cc_icp_clk", &gcc, 0x46, &cam_cc, 0x26 },
	{ "cam_cc_icp_cti_clk", &gcc, 0x46, &cam_cc, 0x30 },
	{ "cam_cc_icp_ts_clk", &gcc, 0x46, &cam_cc, 0x31 },
	...
	{ "cam_cc_mclk4_clk", &gcc, 0x46, &cam_cc, 0x15 },
	{ "cam_cc_soc_ahb_clk", &gcc, 0x46, &cam_cc, 0x2e },
	{ "cam_cc_sys_tmr_clk", &gcc, 0x46, &cam_cc, 0x33 },
